This project contains all the code in a single file, `App.js`, due to difficulties in setting up a systematic file structure on my computer. Below is a brief explanation of the project:
